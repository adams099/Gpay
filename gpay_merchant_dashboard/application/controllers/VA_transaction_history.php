...
class VA_transaction_history extends CI_Controller {
	...
	public function index()
	{
		...
		// Total rows
		$data['total_rows'] = $this->va_transaction_history_model->get_total_row_trans_hist($merchant_id, $receiving_inst_id, $merchant_dashboard_id);
		...
		$data['trans_hist'] =  $this->va_transaction_history_model->get_va_history($merchant_id, $receiving_inst_id, $config['per_page'], $offset, $merchant_dashboard_id);
        ...
        //------------------------------ TEMPLATING ------------------------------
		$template['content'] = $this->load->view('va_transaction/index', $data, true);
	...
	public function submit_search()
    {
		...
		redirect('va_transaction_history/search');
	...
	public function search()
	{
		...
		// Total rows
		$data['total_rows'] = $this->va_transaction_history_model->get_total_row_trans_hist_filtered($search_param, $merchant_id, $receiving_inst_id, $merchant_dashboard_id);
		...
		$data['trans_hist'] =  $this->va_transaction_history_model->get_va_history_filtered($search_param, $merchant_id, $receiving_inst_id, $config['per_page'], $offset, $merchant_dashboard_id );
		$data['store'] =  $this->va_transaction_history_model->get_store_by_merchant_id($merchant_id);
		// $data['offset'] = "Showing ".strval($showing_data_count)." Of ".strval($data['total_rows']);
		$data['offset'] = "Showing ".strval($data_count_begin)." to ".strval($data_count_last)." out of ".$data['total_rows'];
	...
	private function pagination_config($total_rows)
	{
		...
		$config['base_url'] = site_url('va_transaction_history/index');
	...
	{
		$config = $this->global_library->global_pagination_config();
		$config['base_url'] = site_url('va_transaction_history/search');
		$config['total_rows'] = $total_rows;
