...
class VA_dashboard extends CI_Controller {
	...
	public function __construct(){
		...
		$this->load->model('va_dashboard_model');
	...
	public function index()
	{
		...
		$data['trans_hist'] =  $this->va_dashboard_model->get_list_va_dash();
		$data['sum_trx'] =  $this->va_dashboard_model->get_sum_va();
		$data['count_trx'] =  $this->va_dashboard_model->get_count_trx();
		$data['status_new'] =  $this->va_dashboard_model->get_by_status_new();
		$data['status_fail'] =  $this->va_dashboard_model->get_by_status_fail();
		$data['status_void'] =  $this->va_dashboard_model->get_by_status_void();
		$data['time']="Today";
		$data['format'] = "HH:mm";
		$data['last_time'] = "Yesterday";
		// ------------------------------ TEMPLATING ------------------------------ //
		$template['content'] = $this->load->view('va_dashboard/index', $data, true);
