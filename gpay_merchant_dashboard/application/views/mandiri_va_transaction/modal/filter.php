<div class="modal" id="modal_filter" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<!-- Modal Body -->
			<?= form_open('mandiri_va_transaction_history/submit_search'); ?>
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							Virtual Account:
							<div class="custom-control custom-checkbox">
								<input type="checkbox" class="custom-control-input" name="va_all" id="vaAll">
								<label class="custom-control-label" for="vaAll">All</label>
							</div>
							<div class="custom-control custom-checkbox">
								<input type="checkbox" class="custom-control-input" name="va_bni"
									id="vaBni">
								<label class="custom-control-label" for="vaBni">BNI</label>
							</div>
							<div class="custom-control custom-checkbox">
								<input type="checkbox" class="custom-control-input" name="va_mandiri"
									id="vaMandiri">
								<label class="custom-control-label" for="vaMandiri">Mandiri</label>
							</div>
