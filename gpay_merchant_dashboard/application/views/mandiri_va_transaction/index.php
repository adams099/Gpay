<?php
	...
	?>
		...
		<div class="row header">
			...
			<!-- SEARCH PANEL -->
			<a href="<?= site_url('mandiri_va_transaction_history/export'); ?>" class="btn btn-light float-right btn-filter" style="
			...
			<?= $this->session->flashdata('message'); ?>
				...
				<?= form_close(); ?>
						...
						<!-- RESULT DATA -->
							...
							<!-- Modal Filter -->
							<?php $this->load->view('mandiri_va_transaction/modal/filter'); ?>							
